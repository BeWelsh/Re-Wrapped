...
public class SpotifyController {
  ...
  private final String CLIENT_ID = "a4d815a76b9c4fc58fb924a58d776fcc";
  private final String CLIENT_SECRET = "cadd0572edce4ff9b83ce1f03de4db6c";
  private final String REDIRECT_URI = "http://localhost:8080/callback";
  ...
  public ResponseEntity<?> exchangeAuthorizationCode(@RequestBody Map<String, String> requestBody) {
    ...
    try {
      ...
      if (response.getBody().containsKey("error")) {
        System.out.println("Spotify error: " + response.getBody());
